...
* [`src/cljs/cljs_web/`](src/cljs/cljs_web/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cljs_web/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `cljs-web` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cljs_web/config.cljs) defaults to `true` in
...
```clj
(ns cljs-web.example
  (:require [cljs-web.config :as config])
